...
#Region " Overrides "
    ...
    Protected Overrides Sub OnMouseMove(ByVal e As System.Windows.Forms.MouseEventArgs)
        ...
        If Cap Then
            ...
            Parent.FindForm().ShowIcon = True
            Parent.FindForm().ShowInTaskbar = True
        End If
    End Sub
...
Public Class ThirteenControlBox : Inherits Control
    ...
    End Sub
End Class
Public Class ThirteenControlBox2 : Inherits Control
    Enum ColorSchemes
        Light
        Dark
    End Enum
