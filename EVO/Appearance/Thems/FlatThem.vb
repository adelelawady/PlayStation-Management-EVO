...
#Region " Variables"
    ...
    Private State As MouseState5 = MouseState5.None
...
#Region " Mouse States"
    ...
    Protected Overrides Sub OnMouseEnter(ByVal e As EventArgs)
        ...
        State = MouseState5.Over : Invalidate()
    End Sub
    Protected Overrides Sub OnMouseDown(ByVal e As MouseEventArgs)
        MyBase.OnMouseDown(e)
        State = MouseState5.Down : Invalidate()
    End Sub
    Protected Overrides Sub OnMouseLeave(ByVal e As EventArgs)
        MyBase.OnMouseLeave(e)
        State = MouseState5.None : Invalidate()
    End Sub
    Protected Overrides Sub OnMouseUp(ByVal e As MouseEventArgs)
        MyBase.OnMouseUp(e)
        State = MouseState5.Over : Invalidate()
...
#Region " Mouse States"
    ...
    Protected Overrides Sub OnMouseUp(ByVal e As MouseEventArgs)
        MyBase.OnMouseUp(e)
        State = MouseState5.Over : TB.Focus() : Invalidate()
    End Sub
    Protected Overrides Sub OnMouseEnter(ByVal e As EventArgs)
        MyBase.OnMouseEnter(e)
        State = MouseState5.Over : TB.Focus() : Invalidate()
        ...
        With G
            ...
            Select Case K
                ...
                Case _Kind.Error
                    ...
                    Select Case State
                        Case MouseState5.Over ' -- Mouse Over
