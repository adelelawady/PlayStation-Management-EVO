...
Class WinEightButton
    ...
    Protected Overrides Sub PaintHook()
        G.Clear(C1)
        If (State = MouseState3.Over) Then
            DrawGradient(C2, C3, 0, 0, Width, Height)
        ElseIf (State = MouseState3.Down) Then
...
#Region " Sizing and Movement "
    ...
    Protected State As MouseState3
    Private Sub SetState(ByVal current As MouseState3)
        State = current
        Invalidate()
    End Sub
    ...
    Protected Overrides Sub OnEnabledChanged(ByVal e As EventArgs)
        If Enabled Then SetState(MouseState3.None) Else SetState(MouseState3.Block)
        MyBase.OnEnabledChanged(e)
    End Sub

    Protected Overrides Sub OnMouseEnter(ByVal e As EventArgs)
        SetState(MouseState3.Over)
...
#Region " Properties "
    ...
    Property Colors() As Bloom2()
        Get
            Dim T As New List(Of Bloom2)
            Dim E As Dictionary(Of String, Color).Enumerator = Items.GetEnumerator

            While E.MoveNext
                T.Add(New Bloom2(E.Current.Key, E.Current.Value))
            End While

            Return T.ToArray
        End Get
        Set(ByVal value As Bloom2())
            For Each B As Bloom2 In value
...
#Region " Property Helpers "
    ...
    Private Sub InvalidateCustimization()
        ...
        For Each B As Bloom2 In Colors
...
#Region " State Handling "
    ...
    Protected Overrides Sub OnMouseDown(ByVal e As MouseEventArgs)
        If e.Button = Windows.Forms.MouseButtons.Left Then SetState(MouseState3.Down)
        MyBase.OnMouseDown(e)
    End Sub
