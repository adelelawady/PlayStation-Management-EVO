...
#Region "Declarations"
    Private _CloseFormOrWhole As __CloseFormOrWhole = __CloseFormOrWhole.WholeProgram
...
#Region "Properties & Events"
    ...
    Enum __CloseFormOrWhole
        WholeProgram
        Form
    End Enum

    <Category("Control")>
    Public Property CloseFormOrProgrm As __CloseFormOrWhole
        Get
            Return _CloseFormOrWhole
        End Get
        Set(ByVal value As __CloseFormOrWhole)
            _CloseFormOrWhole = value
        End Set
    End Property

    <Category("Control")>
    Public Property FormSelect As Form
        Get
            Return _Form
        End Get
    ...
    Protected Overrides Sub OnMouseDown(ByVal e As MouseEventArgs)
        ...
        If MouseXLoc > Width - 39 AndAlso MouseXLoc < Width - 16 AndAlso MouseYLoc < 22 Then
            Select Case _CloseFormOrWhole
                Case __CloseFormOrWhole.WholeProgram
                    If _AllowClose Then
                        Environment.Exit(0)
                    End If
                Case __CloseFormOrWhole.Form
                    If _AllowClose Then
                        Try
                            _Form.Close()
...
#Region "Declaration"
    ...
    Private _BaseColour As Color = Color.FromArgb(54, 54, 54)
#End Region
...
Public Class LogInPanel
    Inherits ContainerControl
    Public WithEvents VerticalScrollbar As LogInVerticalScrollBar
    Private _BaseColour As Color = Color.FromArgb(55, 55, 55)
    Private _BorderColour As Color = Color.FromArgb(35, 35, 35)
    Private _TextColour As Color = Color.FromArgb(255, 255, 255)
    Private ItemHeight As Integer = 24
...
#Region "Properties & Events"
    ...
    Private Sub HandleScroll(ByVal sender As Object)
        ...
        Me.AutoScrollPosition = New Point(0, VerticalScrollbar.Value)
        Me.AutoScrollMinSize = New Point(0, 30)
        '  MainForm.ThirteenForm1.Text = Me.AutoScrollMargin.ToString & "    " & Me.AutoScrollPosition.ToString & "    " & Me.AutoScrollMinSize.ToString
        'Invalidate()
        InvalidateLayout()
    End Sub
    ...
    Private Sub Tim_Tick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Tim.Tick
        ...
        VerticalScrollbar.Size = New Size(18, Me.Height)
        Invalidate()
    End Sub
...
#End Region
    ...
    'Private Sub VerticalScrollbar_Scroll(ByVal sender As Object) Handles VerticalScrollbar.Scroll
    '    Dim range = VerticalScrollbar.Maximum - VerticalScrollbar.LargeChange + VerticalScrollbar.SmallChange
    '    Dim panelPos = (Me.AutoScrollMinSize.Width - Me.Width) * VerticalScrollbar.Value / range
    '    Me.AutoScrollPosition = New Point(panelPos, 0)
    'End Sub
