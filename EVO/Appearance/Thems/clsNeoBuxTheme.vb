...
MustInherit Class ThemeContainer154_2
...
#End Region
    ...
    Protected Overrides Sub OnHandleDestroyed(ByVal e As EventArgs)
        RemoveAnimationCallback_1(AddressOf DoAnimation)
...
#Region " Property Helpers "
    ...
    Private Sub InvalidateTimer()
        ...
        If _IsAnimated Then
            AddAnimationCallback_1(AddressOf DoAnimation)
        Else
            RemoveAnimationCallback_1(AddressOf DoAnimation)
        End If
    End Sub
...
MustInherit Class ThemeControl154_2
    Inherits Control
...
#Region " Animation "
    ...
    Sub AddAnimationCallback_1(ByVal callback As AnimationDelegate)
        SyncLock Callbacks
    ...
    Sub RemoveAnimationCallback_1(ByVal callback As AnimationDelegate)
        SyncLock Callbacks
