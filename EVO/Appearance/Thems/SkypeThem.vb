...
MustInherit Class ThemeContainer15479
...
MustInherit Class ThemeControl1545
    Inherits Control
...
Class SkypeButton
    ...
    Protected Overrides Sub PaintHook()
        ...
        If State = MouseState2.Down Then
        ...
        ElseIf State = MouseState2.None Then
        ...
        ElseIf State = MouseState2.Over Then
...
Class SkypeAdvertisement
    Inherits ThemeControl154
    Private Function CodeToImage(ByVal Code As String) As Image
        Return ImageM.FromStream(New System.IO.MemoryStream(Convert.FromBase64String(Code)))
    End Function
