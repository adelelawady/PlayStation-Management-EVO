...
Public Class AVProgressBar
    ...
    Private _showCircel As Boolean = True
    Sub New()
        Size = New Size(65, 65)
        Invalidate()
    End Sub
    Public Property ShowCircel As Boolean
        Get
            Return _showCircel
        End Get
        Set(ByVal v As Boolean)
    ...
    Public Property value() As Integer
        ...
        End Set
    End Property
    Private Show_Text As Boolean = True
    ...
    Private Draw_3ircle As Boolean = True
    Public Property Draw_Third_ircle As Boolean
        Get
            Return Draw_3ircle
        End Get
        Set(ByVal v As Boolean)
        ...
        Using B1 As New Bitmap(Width, Height)
            ...
            Using G As Graphics = Graphics.FromImage(B1)
                ...
                If ShowText Then
                    ...
                    G.DrawString(_Value & _Symbol, New Font("Arial", 13), Brushes.White, New Point(Me.Width / 2 - G.MeasureString(_Value & _Symbol, New Font("Arial", 13)).Width / 2 + 1, Me.Height / 2 - G.MeasureString(_Value & "%", New Font("Arial", 13)).Height / 2 + 1))
                End If
            End Using
