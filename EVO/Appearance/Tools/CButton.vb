...
#Region "MouseEvents"
    ...
    '        Call SendMessage(Parent.Handle, WM_LBUTTONDBLCLK, IntPtr.Zero, IntPtr.Zero)
    '    End If
    'End Sub
      ...
      ByVal e As System.Windows.Forms.MouseEventArgs) Handles Me.MouseDown
        ...
        Else
            If Enabled Then
                ...
                ElseIf _SideImageIsClickable AndAlso _
...
Public Class CornersProperty
    ...
    Private _UpperLeft As Int32 = 6
    Private _UpperRight As Int32 = 6
    Private _LowerLeft As Int32 = 6
    Private _LowerRight As Int32 = 6
